  ...
  return (
    <div style={{ display: "flex", justifyContent: "center" }}>
      <div style={{ width: "70%", alignItems: "center" }}>
        ...
        <Tab label="보낸 메시지" onClick={() => rm()} sx={{ fontWeight: "bold", fontSize: "1.2rem" }}></Tab>
        ...
        <Table bordered hover>
          ...
          <thead>
            <tr>
              <th>받는사람</th>
              <th>제목</th>
              <th colSpan="4">보낸날짜</th>
            </tr>
          </thead>

          <tbody>
            {sendmsglist && sendmsglist.length ? (
