...
function MessageInfo() {
  ...
  function getMSglist(page) {
    axios
      .get("http://118.67.132.98:3000/msglist", { params: { pageNumber: page, id: id } })
      .then(function(resp) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center" }}>
      <div style={{ width: "70%", alignItems: "center" }}>
        ...
        <Tab label="받은 메시지" onClick={() => rm()} sx={{ fontWeight: "bold", fontSize: "1.2rem" }}></Tab>
                  ...
                  <tr key={i}>
                    ...
                    <td align="center">
                      <button
                        type="button"
                        onClick={() => {
                          setMsgdetailModal(true);
                          setTargetId(bbs.sendId);
                          setTitle(bbs.title);
                          setMessage(bbs.message);
                        }}
                    ...
                    <td align="center">
                      <button type="button" onClick={() => delMsg(bbs.seq)} className="btn btn-outline-danger">
